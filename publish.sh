...
source2=https://github.com/enanso/JADatePicker.git
...
publishLib(){
    ...
    if ! pod repo push JADatePicker ${SpecName} --allow-warnings --sources="${source1},${source2}" --allow-warnings --use-libraries --skip-import-validation; then echo -e "${RED}发布${tag}版本失败${NC}🌧🌧🌧"; exit 1; fi
